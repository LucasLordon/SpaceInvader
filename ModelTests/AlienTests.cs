...
namespace Model.Tests
{
    ...
    public class AlienTests
    {
        ...
        {
            // Test le déplacement normal de l'alien (moveTestNormal)
        ...
        [TestMethod()]
        public void moveTestExeption()
        {
            // Arrange
            // Test le déplacement lorsque l'alien atteint la limite (moveTestExeption)
